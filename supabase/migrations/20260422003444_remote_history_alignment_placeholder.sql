...
-- This repository no longer contains the original 20260422003444 migration body.
-- Based on commit history, this timestamp fell within the April 21-22 POS migration window
...
select '20260422003444 placeholder migration: no-op for history alignment' as migration_note;
